using System;
using Ex02_X_Mix_Drix;


namespace Ex02_X_Mix_Drix
{
        ...
        private void PlayGame(ref bool iov_IsPlayerWantToExit)
        {
            ...
            while (v_WantToExitWithQ == false && iov_IsPlayerWantToExit == false)
            {
                ...
                while (v_FullMatrix == false && v_WinGame == false)
                {
                    ...
                    {
                        GetComputerCellInput(ref v_FullMatrix, ref v_WinGame, playerNum, m_PlayersArr[playerNum - 1].m_isDifficultyov_Hard);
                    }
